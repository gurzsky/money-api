...
public class ReleaseResume {
	...
	public ReleaseResume(Long codigo, String descricao, LocalDate dataVencimento, LocalDate dataPagamento,
			BigDecimal valor, ReleaseType tipo, String categoria, String pessoa) {
		super();
		this.codigo = codigo;
